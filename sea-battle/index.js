(function (root, factory) {
    ...
    SeeBattle.prototype = {
        // Вызывает функции, которые вставляют базовую html разметку, необходимую для игры
        run: function(){
            this.createToolbar();
        ...
        startNewGame: function(){
            ...
            this.pcInfo.innerHTML = 'Компьютер';
        ...
        // Создание или обновление ячеей в игровых полях
        ...
        // Возвращает id игровой ячейки, генерируемого на базе координат и типа игрового поля
        ...
        // Создает массив с координатами полей, из которых компьютер случайно выбирает координаты для обстрела
        ...
        generateRandomShipMap: function(){
            ...
            while(allShipsPlaced === false){
                ...
                if(this.isPointFree(map, xPoint, yPoint) === true){
                    ...
                    // обновление настроек кораблей, если цикл не был пропущен и корабль стало быть расставлен
        ...
        // Проверка, возможно ли разместить на поле однопалубный корабль
        ...
        // Проверяет, возможно ли вставить корабль горизонтально
        ...
        // Проверяет, возможно ли вставить корабль вертикально
        ...
        // Создает задержку перед ходом компьютера, необходимую для того, чтобы успеть увидеть чей сейчас ход
        ...
        pcFire: function(){
            ...
            var randomShotIndex = this.getRandomInt(1, this._pcShotMap.length);
	...
	//Остановка игры
        ...
        updateToolbar: function(){
            ...
            if(this.isGameStopped()){
                ...
                this.toolbar.innerHTML += ', ходит компьютер';
            }else{
